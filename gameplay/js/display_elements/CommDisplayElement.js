...
* 
* if we want it to automatically scroll only when something new is added, I'll have to do some wrangling 
* (we clear and add all each time...so I'll need to check the before-and-after length)
**/
